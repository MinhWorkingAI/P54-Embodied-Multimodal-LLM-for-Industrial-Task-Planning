...
Run unit tests only (fast, no API):
    pytest tests/test_llm_module.py -v -m "not integration"

Run integration tests against OpenAI:
    LLM_BACKEND=openai pytest tests/test_llm_module.py -v -m integration

Run integration tests against Gemini:
    LLM_BACKEND=gemini pytest tests/test_llm_module.py -v -m integration
"""
...
from llm_backend.edge_cases import (
